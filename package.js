...
var packageName = 'webix:skin-web';  // https://atmospherejs.com/webix/skin-web
...
Package.describe({
  name: packageName,
  summary: 'Web skin for Webix UI',
  version: version,
  git: 'https://github.com/MeteorPackaging/webix-skin-web',
...
Package.onUse(function (api) {
  ...
  api.addFiles(['webix/codebase/skins/debug/web.css'], 'client');
